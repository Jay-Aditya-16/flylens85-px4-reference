...
This register is the entry point for upstream technical information. Vendor files are linked rather than copied so their copyright and update history remain with the publisher. Save a local working copy only for controlled engineering use, record its checksum/date, and confirm it still describes the exact hardware revision.

- **Snapshot date:** 2026-07-25
- **Quality labels:** Primary = manufacturer/protocol owner/upstream project. Secondary = unaffiliated mirror or reseller; use only to identify a gap.
...
| QPT 1404.5 | [Performance image](https://quanteonworld.com/wp-content/uploads/2025/12/Screenshot-2026-01-07-222307.png) | Primary | Test conditions are not sufficiently identified for sizing |
...
| V2 AIO | [MicoAir743V2-AIO-35A page](https://micoair.com/flightcontroller_micoair743v2_aio_35a/) | Primary | Comparison only; do not substitute its target/ESC details |
...
| AIO/ESC | [AM32 setup/update](https://micoair.com/docs/how-to-configure-and-update-am32-esc-on-micoair743-aio/) | Primary | Explains PX4 passthrough limitation |
...
| Nexus1 | [User Manual v1.1 PDF](https://cdn.shopify.com/s/files/1/0567/9038/4729/files/Zerodrag_Nexus1_User_Manual_Version_1.1.pdf?v=1712646205) | Primary | Pinout/specs; PX4-labelled page contains an ArduPilot-only instruction |
| ExpressLRS | [Receiver wiring](https://www.expresslrs.org/quick-start/receivers/wiring-up/) | Primary | CRSF data wiring |
| ExpressLRS | [Firmware compatibility](https://www.expresslrs.org/quick-start/receivers/firmware-version/) | Primary | Major-version requirements |
...
| C10 Pro | [SkyDroid support](https://skydroidglobal.com/pages/skydroid-support) | Primary | C10Pro SDK applicability and control restriction |
...
| C10 Pro | [Manual mirror](https://manuals.plus/ae/1005007476644987) | Secondary | Provisional values only; conflicts with official C10 data |

## PX4 references

| Topic | Document | Notes |
|---|---|---|
| Release | [PX4 v1.17.0](https://github.com/PX4/PX4-Autopilot/releases/tag/v1.17.0) | Repository baseline |
| CRSF | [CRSF telemetry](https://docs.px4.io/v1.17/en/telemetry/crsf_telemetry) | Required custom-driver configuration |
| Companion | [Raspberry Pi companion guide](https://docs.px4.io/v1.17/en/companion_computer/pixhawk_rpi) | UART and separate-power guidance |
| Optical flow | [Optical-flow setup](https://docs.px4.io/v1.17/en/sensor/optical_flow) | Sensor placement and estimator inputs |
| Range | [Rangefinders](https://docs.px4.io/v1.17/en/sensor/rangefinders) | Range-sensor integration |
| Estimator | [EKF2 tuning guide](https://docs.px4.io/v1.17/en/advanced_config/tuning_the_ecl_ekf) | Fusion and validation |
| Magnetometer | [Magnetometer setup](https://docs.px4.io/v1.17/en/gps_compass/magnetometer) | External compass workflow |
| QMC5883L | [Driver reference](https://docs.px4.io/v1.17/en/modules/modules_driver_magnetometer#qmc5883l) | Driver commands |

## Known documentation gaps

No primary dedicated C10 Pro electrical/pinout datasheet was located in the current official download center. No reviewed primary source provides a 2-inch QPT 1404.5 KV4500 thrust curve. The exact Pi, AIO revision, frame revision, transmitter RF variant, receiver target, and “AG01” identity are not determinable from the supplied names alone.
